...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var player = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_1__["default"]('.play', '.overlay');
  player.init();
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          try {
            _this.popup = document.querySelector('.hanson');

            _this.showPopup(_this.popup);
          } catch (e) {}
        });
        btn.parentNode.previousElementSibling.addEventListener('click', function () {
          _this.slideInex = 1;

          _this.showSlide(_this.slideInex);
        });
      });
    }
  }]);
...
function (_Slider) {
  ...
  function MiniSlider(container, nextBtn, prevBtn, animation, autoplay, activeClass, remove) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, nextBtn, prevBtn, animation, autoplay, activeClass, remove));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function prevSlide() {
      var length = this.slides.length - 1;
